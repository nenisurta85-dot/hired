      ...
      <div style={{ background: "#fff", borderRadius: 16, width: "min(760px, 95vw)", maxHeight: "90vh", overflowY: "auto", padding: "28px 32px", boxShadow: "0 8px 40px rgba(0,0,0,0.16)" }} onClick={(e) => e.stopPropagation()}>
        ...
        {isEmail && (
          <div style={{ marginBottom: 16 }}>
            <button onClick={() => showToast("Service package popup — coming soon")}
              style={{ display: "inline-flex", alignItems: "center", gap: 6, background: "var(--purple-light)", color: "var(--purple)", border: "1px solid var(--purple-border)", borderRadius: 20, padding: "5px 14px", fontSize: 12, fontWeight: 600, cursor: "pointer" }}>
              <Icons.Briefcase size={13} /> View service package
            </button>
          </div>
        )}
